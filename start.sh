...
screen -S minecraft -d -m java -Xmx15G -Xms15G -XX:+UseG1GC -XX:G1HeapRegionSize=16M -XX:G1MaxNewSizePercent=45 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1NewSizePercent=30 -jar server.jar nogui
