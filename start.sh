...
cd /workspaces/lr-fr-1211-off/lrxof

SERVER_PROPERTIES_FILE="/workspaces/lr-fr-1211-off/lrxof/server.properties"
...
screen -S minecraft -d -m java -Xmx15G -Xms15G -XX:+UseG1GC -XX:G1HeapRegionSize=16M -XX:G1MaxNewSizePercent=45 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1NewSizePercent=30 -jar forge-1.21.1-52.1.0-shim.jar.jar nogui
